...
$to = "info@flamboyantmirrorman.com";
$subject = "New booking from  flamboyantmirrorman.com";
$errorMessages = array();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (!empty($errorMessages)) {
    $success = "Message Sending Failed, try again";
      ...
      redirect("../index.php?responseMessage=Your message was not sent. Please email us at  info@flamboyantmirrorman.com.#form");
  }
  else {
